...
namespace Examen_T2.Controllers
{
    public class AuthController : BaseController
    {
        ...
        public AuthController(ContexPokemon context, IHostEnvironment hostEnv, IConfiguration configuration) : base(context)
        {
        ...
        [HttpPost]
        public ActionResult Registrar(User user, string password, string passwordpok, string email)
        {
